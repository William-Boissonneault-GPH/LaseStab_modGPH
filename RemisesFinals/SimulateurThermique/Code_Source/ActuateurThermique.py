...
""""Dans ce fichier, il a deux représentation du TEC, un simple (puissance constante dépendament du courant)
et l'autre avec la dynamique décrite dans la fiche technique. Le simple est celui utilisé dans cette version"""
...
class ActionneurThermiqueSIMPLE:
    ...
    def updateMatQTECCourrant(self, courrant):
        #Ces coefficients sont déterminer par identification du prototype physique
